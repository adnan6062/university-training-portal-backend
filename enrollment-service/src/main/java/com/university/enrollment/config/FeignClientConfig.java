...
import com.university.enrollment.exception.ServiceCommunicationException;
...
public class FeignClientConfig {
    ...
    public ErrorDecoder errorDecoder() {
        return (methodKey, response) -> {
            ...
            return switch (response.status()) {
                ...
                case 409 -> new SessionFullException(
                        extractMessage(message, "Conflict: resource already exists or session is full"));
    ...
    private String extractMessage(String raw, String fallback) {
        ...
        // Try to pull the "error" field value out of a JSON body like {"error":"..."}

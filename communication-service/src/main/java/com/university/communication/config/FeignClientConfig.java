package com.university.communication.config;
...
import com.university.communication.exception.ServiceCommunicationException;
    ...
    public ErrorDecoder errorDecoder() {
        return (methodKey, response) -> {
            ...
            return switch (response.status()) {
                ...
                case 409 -> new EnrollmentNotCompletedException(
                        extractMessage(message, "Enrollment is not in a completed state"));
